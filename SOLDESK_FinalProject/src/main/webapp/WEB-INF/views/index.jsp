...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<div id="cont_rank" class="container-fluid text-center">
		...
		<br>
		<div>
			<a href=""><img src="/images/movie_whyHer.jpeg" alt="movie"
				width="40"></a>
			<p>1. 왜 오수재인가?</p>
		</div>
		<div>
		...
		<div>
			<a href=""><img src="/images/movie_theRoundup.jpg" alt="movie"
				width="40"></a>
			<p>3. 범죄도시2</p>
		</div>
	</div>
	...
	<div id="cont_list" class="container-fluid text-center">
		...
		<div class="col-sm-3">
			<div class="thumbnail">
				<a href=""><img src="/images/movie_greenbook.jpg" alt="movie"
					width="280"></a>
				<p>
					<strong>그린북</strong>
				</p>
		...
		<div class="col-sm-3">
			<div class="thumbnail">
				<a href=""><img src="/images/movie_soul.jpg" alt="movie"
					width="280"></a>
				<p>
					<strong>소울</strong>
				</p>
		...
		<div class="col-sm-3">
			<div class="thumbnail">
				<a href=""><img src="/images/movie_jujutsuKaisen.jpg"
					alt="movie" width="280"></a>
				<p>
					<strong>주술회전</strong>
				</p>
				<p>★★★★★</p>
		...
		<div class="col-sm-3">
			<div class="thumbnail">
				<a href=""><img src="/images/movie_dune.jpg" alt="movie"
					width="280"></a>
				<p>
					<strong>듄</strong>
				</p>
